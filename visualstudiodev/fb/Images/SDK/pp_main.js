...
function showMoreFields(obj) {
        switch (obj.options[obj.selectedIndex].value) {
                case "V": case "D": case "M": case "C": case "T":
                        toggleDisabled('switchsolo','select','set');
                        toggleDisabled('switchsolo','input','set');
                        toggleDisabled('dob','input','set');
                        toggleDisplay('bankFields,switchsolo,helpAmex,dob,fieldrowCSCOptional','hide');
                        toggleDisplay('creditCardFields,exp-dt,cvv2,helpVisaMC','show');
                        document.getElementById('cvv2_number').disabled = false;
                        if(obj.options[obj.selectedIndex].value == "T") {
                                toggleDisplay('fieldrowCSCOptional','show');
                                if (document.getElementById('is_cvv_optional') && document.getElementById('is_cvv_optional').checked) {
                                        document.getElementById('cvv2_number').disabled = true;
                                        document.getElementById('cvv2_number').value ='';
                                }
                        }
                        break;
                case "A": case "J":
                        ...
                        toggleDisabled('switchsolo','input','set');
                        toggleDisabled('dob','input','set');
                        toggleDisplay('bankFields,switchsolo,helpVisaMC,dob,fieldrowCSCOptional','hide');
                ...
                case "O": case "S":
                        ...
                        toggleDisabled('dob','input','set');
                        toggleDisplay('dob,fieldrowCSCOptional','hide');
                ...
                case "N":
                        ...
                        toggleDisplay('bankFields,switchsolo,helpAmex,helpVisaMC,cvv2,fieldrowCSCOptional','hide');
                ...
                case "L":
                        ...
                        toggleDisabled('switchsolo','input','set');
                        toggleDisabled('dob','input','remove');
                        toggleDisplay('bankFields,switchsolo,helpAmex,helpVisaMC,cvv2,exp-dt,fieldrowCSCOptional','hide');
                ...
                default:
                        ...
                        toggleDisabled('switchsolo','input','set');
                        toggleDisabled('dob','input','set');
                        toggleDisplay('creditCardFields,exp-dt,switchsolo,cvv2,amexHelp,dob,fieldrowCSCOptional','hide');
